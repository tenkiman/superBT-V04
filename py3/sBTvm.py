...
def isRealTime(tdtgs,age=72.0):
    curdtg=dtg()
    alldtgs=tdtgs
    if(type(tdtgs) == list): alldtgs=[tdtgs]
...
def Model2DataTaus(model,dtg):
    ...
    #
        ...
        if(dtghh == 0 or dtghh == 12):
            taus=list(range(0,72+1,6))+list(range(84,144+1,12))
        elif(dtghh == 6 or dtghh == 18):
            taus=list(range(0,60+1,6))

    elif(model == 'ukmc'):
        if(dtghh == 12):
            taus=list(range(0,72+1,6))+list(range(84,120+1,12))
        elif(dtghh == 0):
            taus=list(range(0,72+1,6))+list(range(84,120+1,12))
        else:
            taus=[]
    ...
    #
        ...
        taus=list(range(0,48+1,6))+list(range(48,240+1,12))

    elif(model == 'jmac'):
        if(dtghh == 12):
            taus=list(range(0,72+1,6))+list(range(84,168+1,12))
        elif(dtghh == 0):
            taus=list(range(0,72+1,6))+list(range(84,84+1,12))
        else:
            taus=[]
...
def getW2fldsRtfimCtlpath(model,dtg,maxtau=None,dtau=6,details=1,override=0,verb=0,doSfc=0):
    ...
    def reducetaus(taus,maxtau='all',dtau=6):
        ...
        rtaus=list(range(0,maxtau+1,dtau))
        for tau in taus:
    ...
    if(stmopt != None):
        ...
        if(len(stmids) == 0):
            ...
            if(len(stmopts) == 1):
                ...
                print ('EEE -getMd2Years tryping to use TcData in python3')
                sys.exit()
